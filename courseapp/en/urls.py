...
urlpatterns = [
    ...
    path('home', views.evvv),
    path('home/<slug:slug>/', views.ev_sonnn, name='ev_sonnn'),
    path('publishing', views.yayıncılıkkk),
    path('publishing/<slug:slug>/', views.yayıncılık_sonnn, name='yayıncılık_sonnn'),
    path('aboutus', views.hakkımızdaaa),
    path('program', views.programmm),
    path('program/<str:kategori>/<slug:slug>/', views.program_etkinlikkk, name='program_etkinlikkk'),
    path('program/<slug:slug>', views.program_detailll, name='program_detailll'),
    path('logo', views.logooo, name='logooo'),
    path('projects', views.projelerrr),
    path('projects/<slug:slug>/', views.projeee, name='projeee'),
    path('projects/<str:kategori>/<slug:slug>/', views.proje_etkinlikkk, name='proje_etkinlikkk'),
    path('archive/<str:kategori>/<str:kategori2>/', views.arşiv_detayyy, name='arşiv_detayyy'),
    path('archive', views.arşivvv),
    path('search_results/', views.search_resultsss, name='search_resultsss'),
    path('calendar', views.takvimmm, name='takvimmm'),
