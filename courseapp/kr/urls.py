...
urlpatterns = [
    path('', views.indexx),
    path('mal', views.evv),
    path('mal/<slug:slug>/', views.ev_sonn, name='ev_sonn'),
    path('weşangerî', views.yayıncılıkk),
    path('weşangerî/<slug:slug>/', views.yayıncılık_sonn, name='yayıncılık_sonn'),
    path('derheqêmede', views.hakkımızdaa),
    path('program', views.programm),
    path('program/<str:kategori>/<slug:slug>/', views.program_etkinlikk, name='program_etkinlikk'),
    path('program/<slug:slug>', views.program_detaill, name='program_detaill'),
    path('logo', views.logoo, name='logoo'),
    path('proje', views.projelerr),
    path('proje/<slug:slug>/', views.projee, name='projee'),
    path('proje/<str:kategori>/<slug:slug>/', views.proje_etkinlikk, name='proje_etkinlikk'),
    path('arşiv/<str:kategori>/<str:kategori2>/', views.arşiv_detayy, name='arşiv_detayy'),
    path('arşiv', views.arşivv),
    path('search_results/', views.search_resultss, name='search_resultss'),
    path('etîketênsîteyê', views.takvimm, name='takvimm'),
